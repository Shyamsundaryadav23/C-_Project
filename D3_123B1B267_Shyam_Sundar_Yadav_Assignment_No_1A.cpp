...
Design a roll call list, arrange list of students according to roll numbers in ascending order 
...
int main() {
    student sobj[20]; // Array to hold details of up to 20 students
    int n;
